...
The right_api_client gem simplifies the use of RigthScale's MultiCloud API. It provides
a simple object model of the API resources by handling all of the fine details of making
HTTP calls and translating their responses.
...
RightScale API 1.5, you should use the latest version of the 1.5 gem (currently 1.5.0).
This will ensure that you get the latest bug fixes for the client.
