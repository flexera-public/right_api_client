...
- right_api_client uses rest_client 1.6.1, so gem install it if you don't have it already.

== Usage Instructions
- Check the examples directory for code snippets on how to use the client.
- New users can start with the following 2 lines of code and navigate their way around the
API by following the available methods:
