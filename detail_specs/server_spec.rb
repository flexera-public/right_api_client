# > cd detail_specs
# > bundle exec spec server_spec.rb 
...
describe "RightApi::Client servers" do
  ...
  it "should return the correct methods for @resource.show.api_methods" do
    ...
    @resource_detail.api_methods.sort.should == [:name, :description, :created_at, :updated_at, :state, :links, :href, :deployment, :next_instance, :launch].sort
  end
  ...
  it "should return the correct methods for @resource.show.api_methods" do
    ...
    @resource_detail_view_instance_detail.api_methods.sort.should == [:name, :description, :created_at, :updated_at, :state, :links, :href, :deployment, :next_instance, :launch].sort
  end
  ...
  it "should return an array of Resources for @resources_deployment.index" do
     ...
     @resources_deployment.index.first.should be_kind_of(RightApi::Resource)
  ...
  it "should return the correct methods for @resource_deployment.show.api_methods" do
    ...
    @resource_deployment_detail.api_methods.sort.should == [:name, :description, :created_at, :updated_at, :state, :links, :href, :deployment, :next_instance, :launch].sort
  end
  ...
  it "should return the correct methods for @resource_deployment.show.api_methods" do
    ...
    @resource_deployment_detail_view_instance_detail.api_methods.sort.should == [:name, :description, :created_at, :updated_at, :state, :links, :href, :deployment, :next_instance, :launch].sort
  end
