...
describe "RightApi::Client volume_attachments" do
  before(:all) do
    @client, @cloud_id, @volume_attachment_id, @volume_id,  @instance_id, @instance_volume_attachment_id = get_ids('volume_attachments')
    @resources = @client.clouds(:id => @cloud_id).show.volume_attachments
    @resource = @client.clouds(:id => @cloud_id).show.volume_attachments(:id => @volume_attachment_id)
    @resource_detail = @resource.show
    
    @resource_volume = @client.clouds(:id => @cloud_id).show.volumes(:id => @volume_id).show.current_volume_attachment
    @resource_volume_detail = @resource_volume.show
    
    @resources_instance = @client.clouds(:id => @cloud_id).show.instances(:id => @instance_id).show.volume_attachments
    @resource_instance = @client.clouds(:id => @cloud_id).show.instances(:id => @instance_id).show.volume_attachments(:id => @instance_volume_attachment_id)
