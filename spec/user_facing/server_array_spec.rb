...
describe "RightApi::Client server_arrays" do
  ...
  it "should return the correct methods for @resource.show.api_methods" do
    ...
    @resource_detail.api_methods.sort.should == [:array_type, :current_instances, :deployment, :description, :destroy, :elasticity_params, :href, :instances_count, :launch, :links, :name, :next_instance, :show, :state, :update].sort
