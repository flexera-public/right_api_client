...
describe "RightApi::Client multi_cloud_images" do
  ...
  it "should return the correct methods for @resource_detail.api_methods" do
    ...
    @resource_detail.api_methods.sort.should == [:description, :href, :links, :name, :revision, :settings, :show].sort
  end
  ...
  it "should return an array of Resources for @resources_server_template.index" do
     ...
     @resources_server_template.index.first.should be_kind_of(RightApi::ResourceDetail)
  ...
  it "should return the correct methods for @resource_detail_server_template.api_methods" do
    ...
    @resource_detail_server_template.api_methods.sort.should == [:name, :description, :revision, :links, :href, :settings, :show].sort
  end
