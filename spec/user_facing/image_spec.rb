...
describe "RightApi::Client images" do
  ...
  it "should return the correct methods for @resource.show.api_methods" do
    ...
    @resource_detail.api_methods.sort.should == [:cloud, :cpu_architecture, :description, :href, :image_type, :links, :name, :os_platform, :resource_uid, :show, :virtualization_type, :visibility].sort
  end
