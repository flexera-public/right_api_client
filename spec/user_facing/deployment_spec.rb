...
describe "RightApi::Client deployments" do
  ...
  it "should return the correct methods for @resource.show.api_methods" do
    ...
    @resource_detail.api_methods.sort.should == [:description, :destroy, :href, :inputs, :links, :name, :server_arrays, :servers, :show, :update].sort
  end
  ...
  it "should return the correct methods for @resource.show.api_methods" do
    ...
    @resource_detail_view_inputs.api_methods.sort.should == [:description, :destroy, :href, :inputs, :links, :name, :server_arrays, :servers, :show, :update].sort
  end
