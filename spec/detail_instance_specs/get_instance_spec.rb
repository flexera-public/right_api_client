# > cd detail_specs
# > bundle exec spec get_instance_spec.rb 
...
describe "RightApi::Client get_instance" do
  ...
  it "should return the correct methods for @resource.show.api_methods" do
    ...
    @resource_detail.api_methods.sort.should == [:cloud, :created_at, :datacenter, :deployment, :description, :href, :image, :inputs, :instance_type, :kernel_image, :links, :live_tasks, :monitoring_metrics, :monitoring_server, :multi_cloud_image, :name, :os_platform, :parent, :private_dns_names, :private_ip_addresses, :public_dns_names, :public_ip_addresses, :ramdisk_image, :resource_uid, :run_executable, :security_groups, :server_template, :ssh_key, :state, :terminate, :terminated_at, :updated_at, :user_data, :volume_attachments].sort
